/*
 * Generated by gdbus-codegen 2.62.1 from tumbler-service-dbus.xml. DO NOT EDIT.
 *
 ...
 */
guint
tumbler_thumbnailer1_override_properties (GObjectClass *klass, guint property_id_begin)
{
...
static void
tumbler_thumbnailer1_proxy_get_property (GObject      *object,
  guint         prop_id,
  GValue       *value,
...
static void
tumbler_thumbnailer1_proxy_set_property (GObject      *object,
  guint         prop_id,
  const GValue *value,
  GParamSpec   *pspec G_GNUC_UNUSED)
{
...
static void
tumbler_thumbnailer1_proxy_iface_init (TumblerThumbnailer1Iface *iface)
{
}
...
static void
tumbler_thumbnailer1_skeleton_dbus_interface_flush (GDBusInterfaceSkeleton *_skeleton)
{
}

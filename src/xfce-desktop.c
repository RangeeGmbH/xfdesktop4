...
struct _XfceDesktop {
    ...
    gboolean enable_icon_context_menu;
...
static struct
{
    ...
    { ENABLE_ICON_CONTEXT_MENU_PROP, G_TYPE_BOOLEAN, "enable-icon-context-menu" },
};
...
xfce_desktop_class_init(XfceDesktopClass *klass)
{
    ...
    g_object_class_install_property(gobject_class, PROP_ENABLE_ICON_CONTEXT_MENU,
                                    g_param_spec_boolean("enable-icon-context-menu",
                                                         "enable-icon-context-menu",
                                                         "enable-icon-context-menu",
                                                         TRUE,
                                                         G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
}
...
xfce_desktop_init(XfceDesktop *desktop)
{
    ...
    desktop->enable_icon_context_menu = TRUE;
}
                          ...
                          GParamSpec *pspec)
{
    ...
    switch(property_id) {
        ...
        case PROP_ENABLE_ICON_CONTEXT_MENU:
            desktop->enable_icon_context_menu = g_value_get_boolean(value);
            break;
                          ...
                          GParamSpec *pspec)
{
    ...
    switch(property_id) {
        ...
        case PROP_ENABLE_ICON_CONTEXT_MENU:
            g_value_set_boolean(value, desktop->enable_icon_context_menu);
            break;
...
gboolean
xfce_desktop_get_enable_icon_context_menu(XfceDesktop *desktop) {
    g_return_val_if_fail(XFCE_IS_DESKTOP(desktop), TRUE);
    return desktop->enable_icon_context_menu;
}
